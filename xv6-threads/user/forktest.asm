...
forktest(void)
{
  ...
  34:	40050513          	addi	a0,a0,1024 # 430 <kthread_join+0xe>
  ...
  56:	42e50513          	addi	a0,a0,1070 # 480 <kthread_join+0x5e>
  ...
  6c:	3d850513          	addi	a0,a0,984 # 440 <kthread_join+0x1e>
  ...
  7e:	3de50513          	addi	a0,a0,990 # 458 <kthread_join+0x36>
  ...
  ae:	3c650513          	addi	a0,a0,966 # 470 <kthread_join+0x4e>
...
0000000000000412 <kthread_create>:
